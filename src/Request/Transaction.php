...
class Transaction implements RequestInterface {
    ...
    public const URL = 'https://app.mutasi.co.id/api/transactions';
    ...
    {
        return $this->getTransaction()->getBody()->getContents();
    }
    ...
    {
        return json_decode($this->getTransaction()->getBody()->getContents());
    }
